...
<script type="text/javascript" src="/static/js/views/contractManage.js"></script>
</head>
<body>
	<!-- 数据表格 -->
	<table id="contractManage_datagrid">

	</table>
	<!-- 新增编辑对话框 -->
	<div id="contractManage_dialog">
		<form id="contractManage_form" method="post" enctype="multipart/form-data">
		<table align="center" style="margin-top: 15px;">
			<input type="hidden" name="id">
<div style="margin-top: 15px" align="center">
	<div>
		<input type="text" name="client.id" id="contractManage_client" class="easyui-textbox" data-options="label:'订单客户:',labelPosition:'top', width:150">
	</div>
	<div>
		<input type="text" name="signTime" class="easyui-datebox" data-options="label:'签订合同时间:',labelPosition:'top', width:150">
	</div>
	...
	<!-- 数据表格CRUD按钮 -->
	<div id="contractManage_datagrid_tb">
		<div>
	...
	data:[{id:'0',name:'生成订单状态'},{id:'1',name:'自我审核状态'},{id:'2',name:'部门审核状态'},{id:'3',name:'财务审核状态'},{id:'4',name:'废单状态'}], width:150">
			...
			<a class="easyui-linkbutton" iconCls="icon-see" id="searchBtn" >搜索</a>
			...
			<a class="easyui-linkbutton" iconCls="icon-audit" id="feiAuditBtn" data-cmd="feiAudit">成为废单</a>

			<a class="easyui-linkbutton" iconCls="icon-see"  data-cmd="openbtn" >打开附件</a>
		</div>

	</div>
	<!-- 对话框保存取消按钮 -->
	<div id="contractManage_dialog_bt">
