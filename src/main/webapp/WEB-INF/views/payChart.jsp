...
<script type="text/javascript" src="/static/js/views/payChart.js"></script>
</head>
<body>
	<!-- 数据表格 -->
	<table id="payChart_datagrid">

	</table>


	<!-- 数据表格CRUD按钮 -->
	<div id="payChart_datagrid_tb">
		<div>
