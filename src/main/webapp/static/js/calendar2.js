var calUtil = {
    ...
    draw: function (signList) {
        ...
        $(".calendar_month_span").html("<div style='display:table;width: 100%'><div style='display:table-cell;width: 40%'>考勤签到</div><div>" + calendarName + "</div><div style='display:table-cell;width: 40%'> <a id='sign'>每日签到</a></div></div>");
    },
    //绑定事件
            ...
            for (d = 0; d < 7; d++) {
                ...
                if (ifHasSigned && typeof(myMonth[w][d]) != 'undefined') {
                    if (ifHasSigned == 1) {
                        ...
                        htmls.push("<div class='td_" + d + " out'>" + (!isNaN(myMonth[w][d]) ? myMonth[w][d] : " ") + "</div>");
                    }
                } else {
