...
public class PayChartController {
    @Autowired
    private IChartService payChartService;
    ...
    @RequestMapping("/list")
    @ResponseBody
    public List<Chart> list(payChartQueryObject qo) {
        List<Chart> charts = payChartService.payChartQuery(qo);
    ...
    public ModelAndView chartList(payChartQueryObject qo) {
        ModelAndView mv = new ModelAndView();
        List<Chart> saleCharts = payChartService.payChartQuery(qo);
        ...
        mv.addObject("typeName", payChartQueryObject.typeMap.get(qo.getGroupbyCon()));
        mv.setViewName("/payHighChart");
        return mv;
    }

    @ResponseBody
    @RequestMapping("chartPie")
    public ModelAndView chartListPie(payChartQueryObject qo) {
        ModelAndView mv = new ModelAndView();
        List<Chart> saleCharts = payChartService.payChartQuery(qo);
        Iterator<Chart> iterator = saleCharts.iterator();
        ...
        mv.addObject("typeName", payChartQueryObject.typeMap.get(qo.getGroupbyCon()));
        mv.setViewName("/payHighChartPie");
        return mv;
    }
